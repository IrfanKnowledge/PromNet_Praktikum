...
<body>
	...
	<div id="editmodal" class="modal fade">
		<div class="modal-dialog">
			<div class="modal-content">
        <form action="<?php echo site_url('C_karyawan/edit'); ?>" method="post">
        ...
        <!--<form>-->
            ...
            <h5>Nama    : </h5> <input type="text" name="name" id="name" required>
            <h5>Email   : </h5> <input type="text" name="email" id="email" required>
            <h5>Address : </h5> <input type="text" name="address" id="address" required>
            <h5>Phone   : </h5> <input type="text" name="phone" id="phone" required>
	...
	<div id="deletemodal" class="modal fade">
		<div class="modal-dialog">
			<div class="modal-content">
        <form action="<?php echo site_url('C_karyawan/delete'); ?>" method="post">
        <!--<form id="form" enctype="multipart/form-data">-->
        <!--<form>-->
					<div class="modal-header">
						<h4 class="modal-title">Delete Employee</h4>
            ...
            <h5>Nama    : </h5>
            <h6 id="name_delete"></h6>
            <h5>Email   : </h5>
            <h6 id="email_delete"></h6>
            <h5>Address : </h5>
            <h6 id="address_delete"></h6>
            <h5>Phone   : </h5>
            <h6 id="phone_delete"></h6>
    ...
    $(document).on("click", "#delete", function() {
        ...
        $(".modal-body #id_delete").val(id);
        document.getElementById("name_delete").innerHTML = name;
        document.getElementById("email_delete").innerHTML = email;
        document.getElementById("address_delete").innerHTML = address;
        document.getElementById("phone_delete").innerHTML = phone;
    })
